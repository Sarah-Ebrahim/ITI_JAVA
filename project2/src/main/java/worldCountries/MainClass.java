...
public class MainClass {
    public static void main(String[] args){
        ...
        List<City> cities = wDAO.readCities("C:\\Users\\MA\\Documents\\NetBeansProjects\\project2\\src\\main\\java\\worldCountries\\Cities.csv");
        List<Country> countries = wDAO.readCountries("C:\\Users\\MA\\Documents\\NetBeansProjects\\project2\\src\\main\\java\\worldCountries\\Countries.csv");
        int i = 0;
